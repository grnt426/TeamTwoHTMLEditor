...
/**
 * Created with IntelliJ IDEA. User: Kocsen Date: 3/21/13 Time: 10:00 AM This is
...
public class FileManager{
	 ...
	 *
	 * @param index - the index of where in the tabs and where in the file array
	 *              the file to deal with is
	 *
	...
	/**
	 * This is in order for every pane that is in the view to have the actual
	 * back end file object (HTMLFile instance) Listen to it for changes.
	 *
